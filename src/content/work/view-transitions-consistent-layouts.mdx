...
image: "../../assets/images/projects/view-transitions-consistent-layouts.png"
...
{/* Demo videos comparing WITH and WITHOUT view transitions */}
<div class="grid sm:grid-cols-2 gap-4">
  <LazyGif 
    src="/demos/with-view-transitions.webm"
    alt="Navigation WITH view transitions"
    caption="✓ WITH View Transitions — smooth morphing between pages"
  />
  <LazyGif 
    src="/demos/without-view-transitions.webm"
    alt="Navigation WITHOUT view transitions"  
    caption="✗ WITHOUT View Transitions — jarring full-page reloads"
  />
</div>
