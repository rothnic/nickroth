...
<figure class="my-10 border-4 border-base-content bg-base-100 p-3 shadow-[8px_8px_0_0_rgba(0,0,0,0.9)]">
  <img src="/assets/diagrams/resume-chatbot-mock-testing.svg" alt="Deterministic testing flow for mock model streams" loading="lazy" />
...
Deterministic tool-call frame checks
...
Avoiding brittle DOM assertions and favored checks
