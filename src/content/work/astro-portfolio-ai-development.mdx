...
### Figma Make → Agent-Assisted Development
The site started as a prototype generated with **Figma Make**, which exported a React codebase. Rather than using the React export directly, AI coding agents used it as a **reference implementation** to convert the design into Astro components while preserving the neobrutalism aesthetic.

This workflow enabled:
- Rapid design iteration without manual CSS translation
- Consistent component structure derived from visual design
- Agent-assisted pattern extraction from prototype code
