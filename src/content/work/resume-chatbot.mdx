...
## <span class="h2-prefix">PROBLEM:</span> <span class="h2-title">Why iterative artifact edits fail at scale</span>
...
## <span class="h2-prefix">STREAMING TYPES:</span> <span class="h2-title">Text vs object vs partial-object streams</span>
...
## <span class="h2-prefix">TOOLING OPTIONS:</span> <span class="h2-title">Approaches to structured document edits</span>
...
## <span class="h2-prefix">SOLUTION:</span> <span class="h2-title">Streaming JSON Patch with partial-object stabilization</span>
...
## <span class="h2-prefix">ARCHITECTURE:</span> <span class="h2-title">System design and implementation</span>
