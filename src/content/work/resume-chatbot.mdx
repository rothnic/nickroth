...
## <span class="h2-prefix">## PROBLEM:</span> <span class="h2-title">Document drift in conversational editors</span>
...
## <span class="h2-prefix">## ARCHITECTURE:</span> <span class="h2-title">Three-layer streaming pipeline</span>
...
## <span class="h2-prefix">## STREAM SEMANTICS:</span> <span class="h2-title">Text vs object/tool-call streams</span>
...
## <span class="h2-prefix">## DEMO:</span> <span class="h2-title">What it shows</span>
...
## <span class="h2-prefix">## NOTES:</span> <span class="h2-title">Implementation and caveats</span>
...
## <span class="h2-prefix">## APPENDIX:</span> <span class="h2-title">Simplified server handler</span>
...
## <span class="h2-prefix">## LESSONS:</span> <span class="h2-title">What we learned</span>
