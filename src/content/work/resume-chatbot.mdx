...
<div class="not-prose tldr-block">
  ...
  <p class="tldr-content">The ideal UX for structured content editing should support:</p>
  <ul class="tldr-list">
    <li><strong>Collaborative interface:</strong> User and AI work together within schema constraints</li>
    <li><strong>Surgical precision:</strong> Parallel, efficient edits to specific fields without full regeneration</li>
    <li><strong>Managed revisions:</strong> Easy recovery from mistakes with clear change history</li>
  </ul>
</div>
...
<figure class="my-10 border-2 border-base-content bg-base-100 p-3 shadow-[4px_4px_0_0_rgba(0,0,0,0.9)]">
  <img src="/assets/diagrams/resume-chatbot-three-streams.svg" alt="Three parallel streams: Backend, Chat, and Artifact channels" loading="lazy" />
  <figcaption class="mt-3 text-sm font-semibold uppercase tracking-wide text-base-content/65">
    Three parallel streams: Backend processing, Chat conversation, and Artifact updates.
  </figcaption>
</figure>
