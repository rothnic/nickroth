...
## <span class="h2-prefix"><span class="h2-hash" aria-hidden="true">##</span> SOLUTION:</span> <span class="h2-title">Surgical JSON patching instead of full regeneration</span>
...
## <span class="h2-prefix"><span class="h2-hash" aria-hidden="true">##</span> STREAM MODEL:</span> <span class="h2-title">Text vs object vs partial-object streams</span>
...
## <span class="h2-prefix"><span class="h2-hash" aria-hidden="true">##</span> DATA MODEL:</span> <span class="h2-title">JSON Resume as a stable mutation surface</span>
...
## <span class="h2-prefix"><span class="h2-hash" aria-hidden="true">##</span> TOOL LAYER:</span> <span class="h2-title">Nested streaming for low-latency structured edits</span>
...
## <span class="h2-prefix"><span class="h2-hash" aria-hidden="true">##</span> TOOLING TRADEOFF:</span> <span class="h2-title">Custom schema tools vs JSON Patch</span>
...
## <span class="h2-prefix"><span class="h2-hash" aria-hidden="true">##</span> PATCH MODEL:</span> <span class="h2-title">Operation shape and partial stabilization</span>
...
## <span class="h2-prefix"><span class="h2-hash" aria-hidden="true">##</span> PROTOCOL:</span> <span class="h2-title">Map natural-language intent to RFC 6902 verbs</span>
...
## <span class="h2-prefix"><span class="h2-hash" aria-hidden="true">##</span> STABILIZATION:</span> <span class="h2-title">Safety valve before UI apply</span>
...
## <span class="h2-prefix"><span class="h2-hash" aria-hidden="true">##</span> CONCURRENCY:</span> <span class="h2-title">Path-isolated operations enable parallelism</span>
...
## <span class="h2-prefix"><span class="h2-hash" aria-hidden="true">##</span> INTEGRATION:</span> <span class="h2-title">Split planning from patch translation</span>
...
## <span class="h2-prefix"><span class="h2-hash" aria-hidden="true">##</span> HYBRID INTERFACE:</span> <span class="h2-title">Document editor plus chat confirmation loop</span>
...
## <span class="h2-prefix"><span class="h2-hash" aria-hidden="true">##</span> ARCHITECTURE:</span> <span class="h2-title">Three synchronized channels with one clear fork</span>
...
## <span class="h2-prefix"><span class="h2-hash" aria-hidden="true">##</span> DEMO:</span> <span class="h2-title">What it shows</span>
