  ...
  features={[
    {
      ...
      description: "User and AI work together within schema constraints"
    },
    {
      icon: "🎯",
      title: "Surgical Precision",
      description: "Parallel, efficient edits to specific fields without full regeneration"
    },
    {
      icon: "🔄",
      title: "Managed Revisions",
      description: "Easy recovery from mistakes with clear change history"
    }
  ]}
/>
